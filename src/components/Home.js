        ...
        return (
          ...
          <div className='jumbotron'>
                <div className='container'>
                  <h1>Precision Wellness</h1>
                  <p className="statement">Therapeutic Massage & Yoga Center</p>
                </div>
          </div>
          <div className='container col-md-8 mt-2 mb-5'>
            <div className='card Home'>
                ...
                <div className='card-body'>
                  <p className="Desc">Award winning, Precision Wellness, located in Springfield, Missouri, has served guests in southwest Missouri, Branson, and surrounding communities since 1995. We are focused on providing our guests with the ultimate therapeutic experience with friendly, knowledgeable Massage Therapists who are dedicated to promoting your well-being. Locally owned and operated, Precision Wellness is part of the Johnson Pharmacy family of companies.</p>
